...
When using the database with vegetation data from the Piedmont Region, it is first necessary to have the species list that can be used in the mixture/donor grassland composition. These species are those that can actually be modelled and amount to 258 species. 
